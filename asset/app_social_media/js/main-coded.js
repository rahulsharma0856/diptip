...
(function ($) {
    ...
    CRUMINA.TopSearch = function () {
        ...
        $('.js-user-search').selectize({
            ...
            searchField: ['name'],
            options: [
              {image: '/socialMediaReward/asset/app_social_media/img/avatar30-sm.jpg', name: 'Marie Claire Stevens12', message:'12 Friends in Common', icon:'olymp-happy-face-icon'},
