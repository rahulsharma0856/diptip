...
<body style=" text-align:center;background-color:#00608f;">
    <div class="col-md-6" style="background-color:#ffffff; min-height:525px; border-right: 1px solid #00608f; border-top: 1px solid #00608f;">
	 
	 
	 
    	   <img src="<?=base_url(ASSET_FOLDER.'images/diptip.png')?>" style="width:70%;margin-top: 12%; height:100% !important;">
		   <br><br><br>
		   <ul style="text-align:left; margin-left:13%">
		   <li class="h3" style="color:#005a87">Share your interests.</li>
		   <li class="h3" style="color:#005a87">Discuss things with people.</li>
		   <li class="h3" style="color:#005a87">Join the conversation.</li>
		   <li class="h3" style="color:#005a87">Promote your business.</li>
    ...
    <div class="col-md-6" style="background-color:#ffffff; border: 0px solid #00608f; padding:2%;border-top: 1px solid #00608f;">
          <div class="mar-ver pad-btm">
            <h1 class="h3" style="color:#005a87">Create a New Account</h1>
                     </div>
          <form action="<?=file_path()?><?=$this->uri->rsegment(1)?>/check" method="post" name="registr" id="registr" onSubmit="return validate1();" enctype="multipart/form-data">
            <input type="hidden" name="ref_key" id="ref_key" value="<?=$user[0]['username']?>">
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <p style="float:left;text-align: left;width: 100%;">
                    ...
                    <span style="font-size: 12px;font-weight:600;padding: 0px 8px;">I have read and agree to the <a style="color:#005a87" target="_blank" href="">Terms & Conditions</a> and <a style="color:#005a87" target="_blank" href="">Privacy Policy</a></span> <?php echo form_error('agree_terms_condi', '<p class="error_p">', '</p>'); ?> </p>
                </div>
              </div>
            </div>
			
            <?php if(isset($user[0])){ ?>
            <button class="btn btn-primary btn-lg btn-block tts" type="submit" style=" background-color:#005a87 !important; border-color:#005a87 !important;">Agree & Register</button>
            <?php }else{ ?>
            <button class="btn btn-primary btn-lg btn-block tts" type="submit" style=" background-color:#005a87 !important; border-color:#005a87 !important;">Agree & Register</button>
            <?php } ?>
            <?php //echo validation_errors(); ?> <?php echo form_error('ref_key', '<p class="error_p">', '</p>'); ?>
          </form>
        <div class="pad-all" style="padding-bottom: 35px;"> Already have an account ? <a href="<?=file_path()?>" class="btn-link mar-rgt text-bold">Sign In</a> </div>
				
	    </div>
      
	  
  <div class="col-md-12" style="color:#FFFFFF; text-align:justify; margin-top:2%">
  <div class="col-md-1">
		...
		$(document).on('submit','#registr',function(e){
			...
			if(txtpass.value!=""){
				...
				if(!txtpass.value.match(mno)){
					...
					alert("Password must contain minimum 9 characters and maximum 30 characters, at least one uppercase letter, one lowercase letter, one number and one special character");
			...
			if (!$('#agree_terms_condi').is(':checked')) {
				...
				alert("Please read all Terms and Conditions and mark tick to go further.");
