<?php
	...
	if($result['type']=='Invite'){
		...
		if($result['pg_type']=='page'){
			...
			$txt = '<a href="'.file_path('page/view/'.$result['pgCode']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">invited you to like</font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';
			
		}
		
		if($result['pg_type']=='group'){
			
			$txt = '<a href="'.file_path('group/view/'.$result['pgCode']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">invited you to join</font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';
	...
	elseif($result['type']=='comment'){
		...
		$txt = '<a href="'.file_path('dashboard/post/'.$result['post_id']).'" class=""><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">commented on your post</font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';	
		
	}
	
	elseif($result['type']=='page_like'){
		
		$txt = '<a href="'.file_path('page/view/'.$result['pgCode']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">liked your page</font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';	
		
	}
	
	elseif($result['type']=='group_join_request'){
		
		$txt = '<a href="'.file_path('group/requests/'.$result['pgCode']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">requested to join group </font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';	
		
	}
	
	elseif($result['type']=='group_join'){
		
		$txt = '<a href="'.file_path('group/members/'.$result['pgCode']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">joined your group</font > <b class="theme-txt2">'.$result['pg_name'].'</b></a>.';	
		
	}
	
	elseif($result['type']=='group_join_accept'){
		
		$txt = '<a href="'.file_path('group/view/'.$result['pgCode']).'" class="theme-txt2">  <font class="theme-txt2">Your request to join </font > <b class="theme-txt2">'.$result['pg_name'].'</b>  <font class="theme-txt2">has been approved. You can now post and comment in this group.</a>.</font >';	
		
	}
	
	elseif($result['type']=='timeline_write'){
		
		$txt = '<a href="'.file_path('dashboard/post/'.$result['post_id']).'" class="theme-txt2"><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">posted on your timeline</font ></a>.';	
	...
	elseif($result['type']=='reply_on_comment'){
		...
		$txt = '<a href="'.file_path('dashboard/post/'.$result['post_id']).'" class=""><font class="theme-txt1">'.$result['member_name'].'</font>  <font class="theme-txt2">replied to your comment</font ></a>.';	
