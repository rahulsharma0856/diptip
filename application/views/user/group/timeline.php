...
<div class="container">
	<div class="row">
		...
		<?php $this->load->view('user/group/bar_left');?>

		
        <?php $this->load->view('user/group/bar_right');?>
  ...
  <script nonce=<?=SC_NONCE?>>
	...
	function load_post(){
		...
		var url='<?=file_path('group/load_post')?><?php echo "?u=".$result[0]['id']?>&s='+total_post;
	...
	function checkNewMessages() {
		...
		var url='<?=file_path('group/checkNewMessages')?><?php echo "?uid=".$result[0]['id']?>&last='+last;
