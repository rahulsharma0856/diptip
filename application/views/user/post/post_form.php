...
<div class="ui-block" style="border: 1px solid #e1e1e3!important;border-radius: 2px;">
  ...
  <div class="news-feed-form"> 
    ...
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item cust_nav_item" > <a class="nav-link active inline-items cust_nav_link" data-toggle="tab" href="#home-1" role="tab" aria-expanded="true"> 
	  
		      <i data-original-title="" data-toggle="tooltip" data-placement="right" class="fa fa-sticky-note" aria-hidden="true"></i>
                  
		
		 <span class="post_status_txt">Create Post</span> </a> </li>
    ...
    <div class="tab-content"> 
      ...
      <?php
	  	...
	  	if($setting['type']=='tag'){ 
			...
			$placeholder = 'Write something on your friend’s timeline...';
      ...
      <div class="tab-pane active" id="home-1" role="tabpanel" aria-expanded="true">
        ...
        <form method="post" id="add_post_status" action="<?=file_path();?>post/add_post_status" enctype="multipart/form-data">
          ...
          <div class="author-thumb"> <img src="<?=thumb(ProfileImg(user_session('profile_img')),150,150)?>" alt="author" style="width:36px;height:36px;"> </div>
          ...
          <div class="add-options-message"> 
            ...
            <a href="javascript:void(0)" id="uploadImageIcon" class="options-message" data-toggle="tooltip" data-placement="top" title="" data-original-title="">
			
			 <i style="font-size: medium !important;float: right;" data-toggle="tooltip" data-placement="right" class="fa fa-photo" aria-hidden="true"> Add Photo</i>
            ...
            <a href="#" class="options-message margin_left_35" id="shareVideoIcon" data-toggle="tooltip" data-placement="top" title="" data-original-title="">
			
			 <i style="font-size: medium !important;float: right;" data-toggle="tooltip" data-placement="right" class="fa fa-video-camera" aria-hidden="true"> Add Video</i>
            ...
            <a href="<?=file_path('tag/tag_member_box/tagListDiv1')?>" id="tagicon1" tag="tagListDiv1" class="options-message margin_left_35 notifiction-popover"  data-toggle="tooltip" data-placement="top" title="" data-original-title=""> 
            
            <i style="font-size:medium;" class="fa fa-users"> Tag friends</i>
            
            </a>
            
            <input type="file" value="upload" id="uploadStatusVideo" name="uploadStatusVideo" accept="video/*" /> 
            
            <button style="float: right;" class="btn btn-primary btn-md-2" type="submit">Share</button>
...
/*.emoji-picker-icon:before {
    ...
    background: url(<?=asset_sm()?>icon-emoji.png);
}
.form-group.with-icon .emoji-picker-icon {
	...
	<?php /*?>$("#post_text").emojionePicker({
	 ...
	 <?php /*?>$(function () {
		...
		window.emojiPicker = new EmojiPicker({
			...
			assetsPath: '<?=asset_sm()?>vendor/emoji-picker/lib/img/',
