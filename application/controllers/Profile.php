...
class Profile extends App
{
    ...
    public function load_friends($uid = '', $start_from = 0)
    {
    ...
    public function edit_profile_submit()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            if ($this->form_validation->run() === false) {
                ...
                $this->session->set_flashdata('show_msg', ['class' => 'true', 'msg' => 'Record Update Successfully...']);
    ...
    public function get_more_photos($member)
    {
    ...
    public function ajax_timeline_video()
    {
    ...
    public function submit_profile_image()
    {
    ...
    public function change_password_insert()
    {
    ...
    public function check_old_password()
    {
        ...
        if ( ! $this->comman_fun->check_record('membermaster', ['usercode' => user_session('usercode'), 'password' => $_POST['old_pass']])) {
    ...
    public function check_new_password()
    {
        ...
        if ($this->comman_fun->check_record('membermaster', ['usercode' => user_session('usercode'), 'password' => $_POST['new_pass']])) {
    ...
    public function friend_request_button($usercode)
    {
    ...
    public function friend_request_send($usercode, $view = 'view1')
    {
    ...
    public function ajaxJosnMemberHtml1($usercode)
    {
    ...
    public function ajaxJosnMemberHtml2($usercode)
    {
        ...
        $data['html'] = $this->load->view('user/search/friend_html', ['result' => $result, 'only_inner' => true], true);

        return $data;

    }

    public function friend_request_delete($usercode, $view = 'view1')
    {
    ...
    public function friend_request_accept($usercode, $view = 'view1')
    {
    ...
    public function friend_delete($usercode)
    {
    ...
    public function ajaxGetAllSummery()
    {
    ...
    public function ajax_member_timeline_post()
    {
    ...
    public function work_experience()
    {
        ...
        $data['skills'] = $this->comman_fun->get_table_data('professional_skills', ['usercode' => user_session('usercode'), 'status' => 'Active']);

        $data['skillslist'] = $this->comman_fun->get_table_data('professional_skills_master', ['id>' => '0']);
    ...
    private function _work_submit()
    {
        ...
        if ($_POST['mode'] != "edit") {
            ...
            $this->comman_fun->update($data, 'work_experience', ['usercode' => user_session('usercode'), 'id' => $_POST['id']]);
        }
    ...
    public function delete_record($eid)
    {
        ...
        $record = $this->comman_fun->get_table_data('work_experience', ['id' => $eid]);

        $data['status'] = 'Delete';

        $this->comman_fun->update($data, 'work_experience', ['id' => $eid]);

        header('Location: ' . file_path('profile/work_experience'));

    }

    public function skills_submit()
    {
    ...
    private function _skills_submit()
    {
        ...
        if ( ! $this->comman_fun->check_record('professional_skills', ['usercode' => user_session('usercode'), 'status' => 'Active'])) {
            ...
            $this->comman_fun->update($data, 'professional_skills', ['usercode' => user_session('usercode'), 'status' => 'Active']);
        }

    }

    public function delete_skill($eid)
    {

        $record = $this->comman_fun->get_table_data('professional_skills', ['id' => $eid]);

        $data['status'] = 'Delete';

        $this->comman_fun->update($data, 'professional_skills', ['id' => $eid]);
    ...
    public function upload_album_photo()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            if ($cpt < 1) {
                echo json_encode(['status' => false, 'msg' => 'File Not Selected']);
            } else {
                $img_html = '';
                ...
                echo json_encode(['status' => true, 'img_data' => $img_html]);
    ...
    public function ajax_get_album_photos($image_path)
    {
        $html = '';
    ...
    public function create_album()
    {
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
            ...
            $this->session->set_flashdata('show_msg', ['class' => 'true', 'msg' => 'Album created Successfully...']);
    ...
    public function delete_album($album_id)
    {
        ...
        if ($return_val == 'true') {
            ...
            $this->comman_fun->delete('social_album_master', ['album_id' => $album_id]);

            $album_img = $this->comman_fun->get_table_data('social_album_images', ['album_id' => $album_id]);

            if (isset($album_img[0])) {
                $this->comman_fun->delete('social_album_images', ['album_id' => $album_id]);
    ...
    public function check_album_for_delete($album_id)
    {
        $record = $this->comman_fun->get_table_data('social_album_master', ['album_id' => $album_id, 'status' => 'Active', 'create_by' => user_session('usercode')]);
    ...
    public function remove_cover_photo()
    {

        $record = $this->comman_fun->get_table_data('membermaster', ['usercode' => user_session('usercode')]);
