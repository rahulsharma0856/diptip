...
class Login extends MY_Controller
{
    ...
    public function authentication_submit()
    {
    ...
    public function check_authentication_code()
    {
    ...
    public function check_google_authentication_code()
    {
    ...
    public function unlock_account($key)
    {
