...
class Dashboard extends CI_Controller {
    ...
    function disable_2fa($member_id) {
    ...
    function verify_email_id($member_id) {
        $data = array();
        $data['email_verify'] = 'Y';
        $this->comman_fun->update($data, 'membermaster', array('usercode' => $member_id));
        $data = false;
