...
class Post extends CI_Controller {
	...
	function check_post_share_video(){
	...
	function load_single_post($id, $section='member',$inner = '0'){
	...
	function PostLikesHtml($post_id){
	...
	function share_popup($post_id = NULL, $section='member'){
	...
	function change_privacy($privacy,$id = NULL){
	...
	function edit_post(int $post_id){
	...
	function postImageDelete(int $imgID){
	...
	function check_valid_edit_post(){
	...
	function get_url_info($url = NULL){
	...
	function check_share_link_from_db($url){
