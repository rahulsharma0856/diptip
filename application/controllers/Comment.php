...
class Comment extends App
{
    ...
    public function check_valid_post_comment()
    {
    ...
    public function load_single_comment(int $id)
    {
    ...
    public function ajax_post_load_comment(int $post_id, $start_from = "0")
    {
    ...
    public function do_like_comment(int $comment_id)
    {
    ...
    public function do_unlike_comment(int $comment_id)
    {
    ...
    public function CommentLikesHtml(int $comment_id)
    {
    ...
    public function get_reply_textarea(int $comment_id)
    {
    ...
    public function add_reply_on_comment()
    {
    ...
    public function check_valid_reply_on_comment()
    {
    ...
    public function ajax_getcomment_reply(int $comment_id)
    {
    ...
    public function load_more_reply(int $comment_id, $start_from = "0")
    {
    ...
    //-------edit comment ----------
    public function get_edit_comment_textarea(int $comment_id)
    {
    ...
    //------edit comment submit---------
    public function edit_comment_on_post()
    {
    ...
    public function check_valid_edit_comment()
    {
        ...
        } elseif($result['usercode'] != user_session('usercode')) {
            $this->form_validation->set_message('check_valid_edit_comment', 'Invaild Request');

            return false;
        } elseif($_POST['comment_mode'] != 'edit') {
            $this->form_validation->set_message('check_valid_edit_comment', 'Invaild Request');
    ...
    //-------edit comment reply ----------
    public function get_edit_comment_reply_textarea(int $comment_id)
    {
    ...
    public function edit_comment_reply_on_post()
    {
    ...
    public function delete_comment_reply(int $comment_id)
    {
        $result =  $this->Comment_model->getCommentById($comment_id);
