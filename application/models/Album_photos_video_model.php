<?php
Class Album_photos_video_model extends CI_Model
{
		
		
		function get_album_photos($albumid)
		{
			$this -> db -> select('*');
		...
		function get_album_by_usercode($usercode)
		{
		...
		function get_tot_photos_in_album($album_id)
		{
