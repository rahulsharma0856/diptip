...
class Email_model extends App_model
{
    ...
    public function send_email2($recepient, $subject, $body, $footer_text)
    {
        ...
        echo $email_body = $this->email_body(['body' => $body, 'subject' => $subject, 'footer_text' => $footer_text]);
    ...
    public function send_email($recepient, $subject, $body, $footer_text)
    {
        ...
        $email_body = $this->email_body(['body' => $body, 'subject' => $subject, 'footer_text' => $footer_text]);
    ...
    public function email_body($arr)
    {
    ...
    public function get_footer($footer_text)
    {
    ...
    public function login_notification($member_id)
    {
        ...
        $payment_option = $this->comman_fun->get_table_data('payment_option', ['id' => $_POST['option_code']]);
    ...
    public function twofa_email($member_id)
    {
    ...
    public function forgot_password($member_id)
    {
    ...
    public function send_email_free($emailid, $subject, $body)
    {
    ...
    public function registration_email($member_id)
    {
    ...
    public function send_email_varification($member_id)
    {
    ...
    public function after_varification_email_verify($member_id)
    {
    ...
    public function replace_member_text($html, $result)
    {
    ...
    public function replace_verify_verify_link($html, $result)
    {
    ...
    public function email_preview($data)
    {

        return $email_body = $this->Email_model->email_body(['body' => $data['msg'], 'subject' => $data['subject']]);

    }

    public function email_contain_replace($email_text, $result)
    {
