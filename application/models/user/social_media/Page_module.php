...
class Page_module extends App_model
{
    ...
    public function isPageAdmin($id)
    {
    ...
    public function getPagelikesMember($id)
    {
    ...
    public function getMyLikedPages()
    {
    ...
    public function getPagePost($endcode)
    {
