...
{
    public function group_list($usercode)
    {
    ...
    public function get_group_details($groupid, $usercode)
    {
        $this -> db -> select('*');
        $this -> db -> from('sm_groups');
    ...
    public function getGroupPost($endcode)
    {
    ...
    public function getMyJoidedGroups()
    {
    ...
    public function getGroupMemberRecord($id)
    {
    ...
    public function isMemberJoinGroup($id)
    {
    ...
    public function isMemberPostInGroup($id)
    {
