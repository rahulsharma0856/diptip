...
class Notification_model extends App_model
{
    ...
    public function updateNotificationStatus()
    {
        ...
        $this->comman_fun->update($data, 'social_notification', ['usercode' => user_session('usercode'), 'status' => 0]);
    ...
    public function updateQuickNotificationStatus()
    {
        ...
        $this->comman_fun->update($data, 'social_notification', ['usercode' => user_session('usercode'), 'quick_view' => '0']);
