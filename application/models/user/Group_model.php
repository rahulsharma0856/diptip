...
class Group_model extends App_model
{
    ...
    public function isRequestSend($id)
    {
    ...
    public function isGroupJoined($id)
    {
    ...
    public function isRequestPending($id)
    {
    ...
    public function getMemberJoinedGroups($uid, $limit = null)
    {
    ...
    public function getJoinedGroupListForPost()
    {
    ...
    public function countTotalGroupJoined($page_code)
    {
    ...
    public function getGroupJoinRequest($id)
    {
    ...
    public function getGroupJoinedMemberList($id)
    {
    ...
    public function getJoinRequestById($id)
    {
    ...
    public function send_join_request($id)
    {
    ...
    public function leave_group($id)
    {
        ...
        $this->comman_fun->delete('social_page_group_member', ['pg_code' => $id, 'usercode' => user_session('usercode'), 'type' => 'group']);

    }

    public function join_request_accept($request)
    {
        ...
        $this->comman_fun->update($data, 'social_page_group_member', ['id' => $request[0]['id']]);
    ...
    public function isGroupInvitation($id)
    {
        $this->db->select('*');
