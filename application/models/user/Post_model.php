...
Class Post_model extends CI_Model{
	...
	function get_post_master($post_id){
	...
	function post_member_add($post_id){
	...
	function post_image_update($post_id){
	...
	function getMasterPostByPostcode($id){
	...
	function getMembertimelinePost($id,$start_from=0){
	...
	function getMembertimelineVideo($id,$start_from=0){
	...
	function checkMembertimelineNewMessages($id,$last){
	...
	function getMembertimelineNewMessages($id,$last){
	...
	function getPostImage($post_code){
...
//			}
	...
	function PostHederInfoSet($data){
	...
	function share_post($arr){
		...
		function checkPagetimelineNewMessages($id,$last){
		...
		function getPagetimelineNewMessages($id, $last){
		...
		function getPageTimelinePost($id,$start_from=0){
		...
		function checkMemberHomeNewMessages($last){
		...
		function getMemberHomeNewMessages($last){
		...
		function getMemberHomePost($start_from=0){
		...
		function checkGrouptimelineNewMessages($id,$last){
		...
		function getGrouptimelineNewMessages($id,$last){
		...
		function getGroupTimelinePost($id,$start_from=0){
		...
		function isMemberLikePost($post_id){
		...
		function countPostTotalLikes($post_id){
		...
		function postCountLikesCommentShare($post_id){
		...
		function getUserPostPhotos($usercode,$start_from=0){
		...
		function countTotUserphotos($usercode)
		{
		...
		function getWhoLikesbyPostid($postid,$start_from=0)
		{
			$this -> db -> select('s.*');
		...
		function getPostTaggedMember($post_id = NULL, $limit = 1){
		...
		function getCountPostTaggedMember($post_id = NULL){
		...
		function change_privacy($privacy,$post_id){
