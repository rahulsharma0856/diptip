...
class Post_model extends App_model
{
    ...
    public function post_image_update($post_id)
    {
        ...
        $this->comman_fun->update($data, 'social_posts', ['id' => $post_id]);
    ...
    public function do_unlike_post($post_id)
    {
        ...
        $this->comman_fun->delete('social_likes', ['post_id' => $post_id, 'usercode' => user_session('usercode')]);

        $this->comman_fun->delete('social_notification', ['post_id' => $post_id, 'usercode2' => user_session('usercode'), 'type' => 'like']);
    ...
    public function delete_post($post_id)
    {
        ...
        if (isset($result[0]) && $result[0]['added_by'] == user_session('usercode')) {
            ...
            $this->comman_fun->update($data, 'social_post_master', ['post_id' => $post_id, 'added_by' => user_session('usercode')]);
