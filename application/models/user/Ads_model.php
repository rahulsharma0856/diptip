...
Class Ads_model extends CI_Model{
	...
	function getAdsSelectCountry($id = NULL){
	...
	function getMemberLikesSummary($uid = NULL){
	...
	function getTotalLikesUse($uid = NULL){
	...
	function getTotalLikes($uid = NULL){
	...
	function totAdsShare($id = NULL, $post_id = NULL){
	...
	function getAdTotalLike($id = NULL){
