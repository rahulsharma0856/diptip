...
{
    public function find_member($filter_by, $start_from = 0, $limit = 4)
    {
    ...
    public function filterSearchBoxInput($filter)
    {
    ...
    public function filter_page($filter_by, $start_from = 0, $limit = 4)
    {
    ...
    public function filter_group($filter_by, $start_from = 0, $limit = 4)
    {
    ...
    public function find_friend($filter_by, $start_from = 0, $limit = 20)
    {
