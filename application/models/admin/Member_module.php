...
Class Member_module extends CI_Model
{
	...
	function check_under_review_member($eid){
	...
	function get_downline_free($eid='')
	{
		$this -> db -> select('*');
	...
	function get_count_downline_free($eid=''){
	...
	function get_member_payment_gateway($eid){
	...
	function get_payment_gateway_list()
 	{	
